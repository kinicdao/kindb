...
export async function searchContent(serviceActor, query) {
  ...
  const page_count_include_the_word = JSON.parse(fs.readFileSync("src/scripts/crawler/regulared_words_chunks/page_count_include_the_word.json", 'utf8'));
